...
type EnrollmentCancelledEvent struct {
	// Header field for this event
	EventHeader EventHeader `json:"eventHeader"`
	// Enrollment entity canceled
	Enrollment Enrollment `json:"enrollment"`
}

const EnrollmentCancelledEventAvroCRC64Fingerprint = "f\xf9\xbd\n]\xa8f\xe1"

func NewEnrollmentCancelledEvent() EnrollmentCancelledEvent {
	r := EnrollmentCancelledEvent{}
...
func DeserializeEnrollmentCancelledEvent(r io.Reader) (EnrollmentCancelledEvent, error) {
	t := NewEnrollmentCancelledEvent()
...
func DeserializeEnrollmentCancelledEventFromSchema(r io.Reader, schema string) (EnrollmentCancelledEvent, error) {
	t := NewEnrollmentCancelledEvent()
...
func writeEnrollmentCancelledEvent(r EnrollmentCancelledEvent, w io.Writer) error {
	var err error
...
func (r *EnrollmentCancelledEvent) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EnrollmentCancelledEvent) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EnrollmentCancelledEvent) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EnrollmentCancelledEvent) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EnrollmentCancelledEvent) Finalize()                        {}

func (_ EnrollmentCancelledEvent) AvroCRC64Fingerprint() []byte {
	return []byte(EnrollmentCancelledEventAvroCRC64Fingerprint)
}

func (r EnrollmentCancelledEvent) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EnrollmentCancelledEvent) UnmarshalJSON(data []byte) error {
